...
[![Made with Markdown](https://img.shields.io/badge/Made%20with-Markdown-000000?style=for-the-badge&logo=markdown&logoColor=white)](https://www.markdownguide.org/)
[![Open Source](https://img.shields.io/badge/Open%20Source-%E2%9D%A4-red?style=for-the-badge)]()

[![Contributors](https://img.shields.io/github/contributors/HereIsMuhammad/top-github-profile-readme?style=for-the-badge)]()
[![Stars](https://img.shields.io/github/stars/HereIsMuhammad/top-github-profile-readme?style=for-the-badge)]()
[![Forks](https://img.shields.io/github/forks/HereIsMuhammad/top-github-profile-readme?style=for-the-badge)]()
[![Last Commit](https://img.shields.io/github/last-commit/HereIsMuhammad/top-github-profile-readme?style=for-the-badge)]()

# Top GitHub Profile READMEs 🌟

A community-curated collection of standout GitHub profile READMEs.

Your GitHub profile README is often the first thing people see when they
click your username, before your pinned repos, before your contribution
graph. This project collects genuinely well-made examples in one place, so
anyone looking for inspiration (or just curious what's possible) has
somewhere to browse.

If you've put effort into your profile README and you're proud of it, open
a PR and add yourself to the list below, or reach out and I'll add it.

## 📋 Table of Contents

- [What This Is](#what-this-is)
- [Browse the List](#browse-the-list)
- [How to Add Yours](#how-to-add-yours)
- [Contributing Guidelines](#contributing-guidelines)
- [License](#license)

## What This Is

This repo is just a table. Each row links to a GitHub profile and to the
raw README file that powers it, so you can see both the live result and
the markdown/HTML behind it. No profile is too simple or too fancy to be
listed, what matters is that it's genuinely yours and it's put together
with some care.
...
| Karim Abdallah | [karim-eg](https://github.com/karim-eg) | [README](https://github.com/karim-eg/karim-eg) |
| Livio Brunner | [BrunnerLivio](https://github.com/BrunnerLivio) | [README](https://github.com/BrunnerLivio/BrunnerLivio) |
| Code Bullet | [Code-Bullet](https://github.com/Code-Bullet) | [README](https://github.com/Code-Bullet/Code-Bullet) |
| Emil Widlund | [emilwidlund](https://github.com/emilwidlund) | [README](https://github.com/emilwidlund/emilwidlund) |
| Terkel Gjervig | [terkelg](https://github.com/terkelg) | [README](https://github.com/terkelg/terkelg) |
| Avinal Kumar | [avinal](https://github.com/avinal) | [README](https://github.com/avinal/avinal) |
| Suman Shekhar | [sumanshekhar698](https://github.com/sumanshekhar698) | [README](https://github.com/sumanshekhar698/sumanshekhar698) |
...
2. Add a new row to the table above with:
   - Your name (or however you'd like to be listed)
   - A link to your GitHub profile
   - A link to your profile README's source file
3. Keep the table sorted alphabetically by first name
...
- The profile README must be your own, publicly visible work
- Keep the PR focused: just your table row, no unrelated changes
- Be respectful, no offensive usernames, content, or links

See [CONTRIBUTING.md](CONTRIBUTING.md) for the full guide.

## License

MIT, see [LICENSE](LICENSE) for details. Feel free to fork this idea and
run your own version too.
